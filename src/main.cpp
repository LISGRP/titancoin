...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Greekcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "sector Lambda";
        CTransaction txNew;
        txNew.nTime = 1401826604;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1401826604;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2750042;
		if(fTestNet)
        {
            block.nNonce   = 34999;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x159851800b8b19630b60ea6dc824bc059cc2bc5ae765eb9cbc36475889168794"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa3, 0xa1, 0xa2, 0xa3 };
